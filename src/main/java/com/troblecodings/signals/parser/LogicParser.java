...
public final class LogicParser {
    ...
    static {
        // IModelData was only used here as a type token for this predicate family; the predicates
        // themselves take a ModelInfoWrapper, which is the natural marker now that ModelData is a
        // final class.
